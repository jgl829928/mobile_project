                ...
                dom_box.click(function (e) {
                   ...
                   if($(e.target)[0].style.backgroundImage== "" && ($(e.target).attr("src") == undefined||($(e.target).attr("src").trim() == ""))) //排除其它点击区域
                    ...
                    if (!$(".detail_look").length) {
                        $('body').append('<div class="detail_look" swiper_clickLook ><em><b></b>/<i></i></em><div class="swiper-container" id="Myswiper_clickLook"><div class="swiper-wrapper flex_item_mid"></div></div><span class="close_btn"></span></div>');
                    ...
                    $(".detail_look[swiper_clickLook] .close_btn").click(function () {
                    ...
                    img_ary.each(function () {
                    	...
                    	{
                          doms_string.push($(this).attr("src") ? $(this).attr("src") : $(this)[0].style.backgroundImage.split("(")[1].split(")")[0])
                    	}
                    ...
                    $(".detail_look  #Myswiper_clickLook .swiper-wrapper").empty();
                    var len = doms_string.length

                    while (doms_string.length) {
                    	var ImgUrl=doms_string.shift();
                    	
                        $(".detail_look #Myswiper_clickLook .swiper-wrapper").append('<div class="swiper-slide"><div class="look_box"><img src=' + ImgUrl + '/></div></div>')
                    }
